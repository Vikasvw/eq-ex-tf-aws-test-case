workspace_iam_roles = {
  test = "arn:aws:iam::111111111111:role/test-terraform-role" # Update the IAM role ARN
}
Environment = "test"
...
test_ec2_ami_id        = "ami-12345" # Update the AMI ID. This is tested on Amazon Linux 2 AMI.
test_ec2_instance_type = "t2.micro"
key_pair_name          = "test-key" # Also make sure this Key is precreated.
